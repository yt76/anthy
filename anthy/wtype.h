...
#define COS_KK 4
/* 一般接頭辞・接尾辞 */
#define COS_POSTFIX 5
/* サ変の接尾辞 */
#define COS_SVSUFFIX 6
#define COS_CNSUFFIX 7
#define COS_PREFIX 8
#define COS_NR 9
/**/
...
#define WT_COMPOUND 255
int anthy_wtype_get_id(const char *n);
const char *anthy_id_to_wtype(int id, wtype_t *w);
...
int anthy_wtype_get_vsuffix(wtype_t w);
...
extern wtype_t anthy_wt_t35;/* 名詞 */
